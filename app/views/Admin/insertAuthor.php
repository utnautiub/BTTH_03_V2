...
<body>
    ...
    <div class="container-fluid p-5">
        ...
        ?>
        <h3 style="text-align: center; font-weight: 700;" class="my-3">ADD INFO AUTHOR</h3>
        <form method="post" action="<?php $_SERVER['DOCUMENT_ROOT']?>/CSE485_0923/BTTH_03_V2/public/index.php?controller=Admin&action=InsertAuthor">
            ...
            <div class="button-add-back">
                <button name="submitInsertAuthor" type="submit" class="btn btn-success m-2">Save</button>
                <a href="#">
