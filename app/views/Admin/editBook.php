    ...
    <div class="container-fluid p-5">
        ...
        error_reporting(E_ALL);
             if(isset($_GET['token'])){
                  ...
                  $publicationYear = $token['publicationYear'];
                  $idAuthor = $token['idAuthor'];
             }
        ?>
        <h3 style="text-align: center; font-weight: 700;" class="my-3">EDIT INFO BOOK</h3>
        <form method="post" action="<?php $_SERVER['DOCUMENT_ROOT']?>/CSE485_0923/BTTH_03_V2/public/index.php?controller=Admin&action=EditBook">
